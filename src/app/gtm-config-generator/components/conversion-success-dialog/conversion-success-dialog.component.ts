    ...
    <mat-dialog-content class="conversion-success__options">
      <div class="conversion-success__options__option">
        <button mat-stroked-button>
          <mat-icon (click)="onDownload()">cloud_download</mat-icon>Download
        </button>
      </div>
      <div class="conversion-success__options__option">
        <button mat-stroked-button>
          <mat-icon (click)="onClipBoard()">file_copy</mat-icon>Copy to
          clipboard
        </button>
      </div>
    </mat-dialog-content>
...
export class ConversionSuccessDialogComponent {
  constructor(@Inject(MAT_DIALOG_DATA) public configuration: any) {}
